...
Neste bloco você vai apresentar a ideia central do trabalho, de forma clara e objetiva, apresentar os objetivos (geral e secundários do estudo). Segue alguns exemplos de perguntas que você pode responder:
...
> O trecho abaixo responde as seguintes perguntas: "Quais os problemas causados pela não calibração dos equipamentos?" e "Quais os problemas causados pela má calibração dos equipamentos?"
...
> O trecho abaixo responde a seguinte pergunta: Qual a necessidade de calibrar os equipamentos médico-hospitalares?
...
> O trecho abaixo responde a seguinte pergunta: Os EAs do brasil realizam a calibração e manutenção necessária?
...
> O trecho abaixo responde as seguintes perguntas: Quem é responsável por prestar esse serviço (no Brasil)?
...
> O trecho abaixo exemplifica como expor os objetivos do trabalho:
...
** Como eu sei que terminei a Introdução?

## Considerações sobre a introdução

Lembrando que na introdução você deve fazer um apanhado geral do seu trabalho, contextualizar o leitor de forma clara e objetiva. Seja breve mas seja coeso e claro.

A introdução é um dos últimos tópicos a se escrever no trabalho, porque você precisa de material, embasamento téorico e entendimento sobre o tema.
